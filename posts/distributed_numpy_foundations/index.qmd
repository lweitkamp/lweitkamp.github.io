...
``` {.python height="200px" width="500px"}
def scatter(
...
The solution that I found for this is rather ugly and involves splitting the gathered results and reshaping appropriately, but it does work[^8].

[^8]: If you know there is a better way of dealing with this, please reach out!
